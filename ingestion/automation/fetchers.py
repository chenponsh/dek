...
from .core import Row, SafetyStop, merge_duplicate_rows, restore_book_titles
    ...
    with sync_playwright() as pw:
        ...
        try:
            ...
            for kind in types:
                ...
                rows = merge_duplicate_rows([Row(restore_book_titles(str(x["probleContent"])), restore_book_titles(str(x["answerContent"])), str(x["publishTime"])[:10]) for x in records])
